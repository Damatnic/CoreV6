...
export class WebSocketServer {
  ...
  private setupEventHandlers(): void {
    (this.io as any).on("connection", (socket: Socket) => {
      ...
      // Message Events
      (authSocket as any).on(MessageEvent.SEND, (data: MessagePayload, callback) =>
        this.handleMessageSend(authSocket, data, callback)
      );
      (authSocket as any).on(MessageEvent.EDIT, (data: any, callback) =>
        this.handleMessageEdit(authSocket, data, callback)
      );
      (authSocket as any).on(MessageEvent.DELETE, (data: any, callback) =>
